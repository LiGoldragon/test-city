...
export TEST_CITY_LIFECYCLE_CHURN_CYCLES="${TEST_CITY_LIFECYCLE_CHURN_CYCLES:-3}"
export TEST_CITY_LIFECYCLE_CHURN_WORKER_KILLS="${TEST_CITY_LIFECYCLE_CHURN_WORKER_KILLS:-3}"
export TEST_CITY_OBSERVATION_SECONDS="${TEST_CITY_OBSERVATION_SECONDS:-900}"
