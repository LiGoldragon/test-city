...
export TEST_CITY_AFTER_HEALTH_SCRIPT="${TEST_CITY_AFTER_HEALTH_SCRIPT:-checks/wake-auditor.sh}"
export TEST_CITY_OBSERVATION_SECONDS="${TEST_CITY_OBSERVATION_SECONDS:-300}"
